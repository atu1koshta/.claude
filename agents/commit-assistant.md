...
description: "Automatically commit staged changes with a conventional commit message. Triggered whenever the user mentions @commit-assistant — no additional instructions needed. Analyzes staged changes, crafts a commit message, shows a confirmation prompt, and commits upon approval."
model: haiku
color: pink
---
